...
function Navbar() {
  ...
  return (
    <motion.nav
      ...
      initial="hidden"
      animate="show"
      className="fixed lg:justify-between z-50 bg-customPurple300 left-0 right-0 backdrop-blur"
    >
      <nav className="w-full">
        ...
        <div className="justify-between px-2 lg:px-0 mx-auto lg:max-w-7xl md:items-center md:flex backdrop-blur">
          <div>
            <div className="items-center inline-flex justify-between py-3 md:py-0 lg:py-0">
              {/* LOGO */}
              <Link href="/">
                <Image
          ...
          >
            <ul className="h-screen md:h-auto lg:text-sm md:text-sm text-xl items-center justify-center md:flex">
