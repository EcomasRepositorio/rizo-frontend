      ...
      <div className="py-3 shadow-md max-w-screen-xl mx-auto p-2 flex justify-between items-center flex-wrap lg:flex-nowrap">
        ...
        <Link href="/">
          <Image
            ...
            height={800}
            alt="rizo-logo"
            className='md:w-48 w-36 h-auto mb-2'
            priority={true}
          />
        </Link>

        <button className="flex justify-center items-center md:hidden visible hover:scale-110 duration-300" onClick={() => setOpen(!open)}>
          {open ? <GrClose className='text-3xl text-customYellow z-50'/> : <TfiMenuAlt className='text-3xl text-customYellow mb-3' />}
        </button>
        ...
        <button className="hidden md:flex justify-center items-center hover:scale-125 duration-300" onClick={() => setOpen(!open)}>
        ...
        <div className="bg-customYellow/60 w-[300px] md:w-[450px] lg:w-[500px] rounded-2xl flex flex-col justify-center items-center">
          ...
          <ul className="text-xl items-center justify-center">
                ...
                <li className="flex justify-center mb-6">
                  <Link href="/login" onClick={() => setOpen(!open)} className="py-1 px-4 rounded-xl text-customPurple300 hover:bg-customPurple300 hover:text-customYellow hover:scale-125 duration-300">
