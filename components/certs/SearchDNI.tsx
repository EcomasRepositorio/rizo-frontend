        ...
        <div className="flex items-center ">
          <div className=" flex-1">
            <input
              type="search"
              id="default-search"
              className="text-md text-gray-900 border-1 border-gray-300 rounded-lg bg-white font-light  focus:border-primaryblue  m-0"
          ...
          <div className=" ml-2 h-full">
            <Button
              type="submit"
              className="bg-transparent text-white border  border-white/50 rounded-lg"
            >
              Buscar
            </Button>
          </div>
